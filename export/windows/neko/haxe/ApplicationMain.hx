...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Testing shit", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Testing shit";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Testing shit", null, { width: 1920, height: 1080 });
